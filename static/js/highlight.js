    ...
    ne = (t) => {
      ...
      function f(e, t, i, r) {
        ...
        function b(e, n) {
          return (
            e.scope &&
              ...
              M.openNode(N.classNameAliases[e.scope] || e.scope),
            e.beginScope &&
              (e.beginScope._wrap
                ? (g(
                    S,
        ...
        let S = '',
          ...
          R = !1;
        try {
          if (N.__emitTokens) N.__emitTokens(t, M);
          else {
        ...
        Object.assign(t, {
          ...
          registerLanguage: (e, n) => {
            ...
            (i.name || (i.name = e),
              ...
              i.aliases && O(i.aliases, { languageName: e }));
          },
  ...
  var Ke = Object.freeze({
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        i = { match: [/\./, m(...xe, ...Me)], className: { 2: 'keyword' } },
        ...
        S = { scope: 'regexp', variants: [M('###'), M('##'), M('#'), x] },
        A = { match: b(/`/, Fe, /`/) },
        C = [
          A,
