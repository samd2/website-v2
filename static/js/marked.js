...
(function (g, f) {
  ...
  function () {
    ...
    var ye = (l) => we(G({}, '__esModule', { value: !0 }), l);
    var dt = {};
    Oe(dt, {
      Hooks: () => S,
      Lexer: () => x,
    ...
    var Pe = (() => {
      ...
      je = k(ce, 'u').replace(/punct/g, D).getRegex(),
      Qe = k(ce, 'u').replace(/punct/g, pe).getRegex(),
      he =
...
`),
            ...
            (this.options.gfm &&
              ...
              O && (c = c.replace(this.rules.other.listReplaceTask, ''))),
              i.items.push({
                type: 'list_item',
                raw: p,
                task: !!O,
...
Please report this to https://github.com/markedjs/marked.`),
    ...
    d.options = d.setOptions = function (l) {
      return (L.setOptions(l), (d.defaults = L.defaults), N(d.defaults), d);
    };
    d.getDefaults = _;
    d.defaults = T;
    d.use = function (...l) {
      return (L.use(...l), (d.defaults = L.defaults), N(d.defaults), d);
    };
